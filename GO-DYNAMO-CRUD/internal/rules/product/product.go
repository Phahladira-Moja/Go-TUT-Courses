...
import (
	"encoding/json"
	"errors"
	"githhub.com/phahladira-moja/dynamodb-bulletproof-crud-api/internal/entities"
	"githhub.com/phahladira-moja/dynamodb-bulletproof-crud-api/internal/entities/product"
